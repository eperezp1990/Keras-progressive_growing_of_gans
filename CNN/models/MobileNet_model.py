...
def MobileNet_sinpesos():
	return {"model": model_sinpesos, "name": "MobileNet_sinpesos", "shape": (224, 224, 3)}
...
def MobileNet_transfer():
	return {"model": model_imagenet_transfer, "name": "MobileNet_transfer", "shape": (224, 224, 3), 
			"transfer": True}
